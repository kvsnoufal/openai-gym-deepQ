...
for i_episode in range(1, n_episodes+1):
    ...
    if i_episode % 100 == 0:
        agent.model.save_weights("./weightsfolder/cpoleFT_weights_{}.h5".format(i_episode))
    if i_episode % 10 == 0:
...
plt.ylabel('Epsilone')
plt.xlabel('Episode #')
plt.savefig("epsilonFT.png")
# plt.show()  
agent.model.save_weights("./weightsfolder/cartpoleFT_agent_weights.h5")